...
public class RedisUtil {
	 ...
	 * @return
	 */
	public boolean setRedisLock(String lockKey, String requestID, int expire) {
		boolean result;
		result = redisTemplate.opsForValue().setIfAbsent(lockKey, requestID, Duration.ofMillis(expire));
		return result;
	}
	 ...
	 */
	public Long luaExistKeyDel(String lockKey, String requestID,String scriptPath) {
